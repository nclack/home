...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/738a60a8-97ff-4839-a3e5-0bf98df3c2f3";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/B286-6DFD";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/3f3d51a7-d856-4e7f-a528-a3c58c06fb89"; }
    ];
